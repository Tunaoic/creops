...
[![CI](https://github.com/Tunaoic/creops/actions/workflows/ci.yml/badge.svg)](https://github.com/Tunaoic/creops/actions/workflows/ci.yml)
...
> Replace `Tunaoic/creops` in the badges above after pushing to GitHub.
